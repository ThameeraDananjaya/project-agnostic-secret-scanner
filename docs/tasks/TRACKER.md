...
| PSCAN-06 | Correction C1 candidate implemented; callable author checks pass, actual-Linux host proof and independent acceptance remain open | `evidence/PSCAN-06/CORRECTION-C1-AUTHOR-VALIDATION-002.md` |
...
candidate `f24b832ebe5f6749aa0ab910e1b9be279065ebb1`. Two offline builds and all
