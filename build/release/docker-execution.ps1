...
cp /work/tooling/contracts/release-manifest/schema-2.4.json /out/tooling-materialized/contracts/release-manifest/schema-2.4.json
cp /work/tooling/contracts/release-manifest/schema-2.5.json /out/tooling-materialized/contracts/release-manifest/schema-2.5.json
