...
| PSCAN-02 | Activated; unclaimed; not implemented | Owner command plus PSCAN-02 activation bundle |
...
PSCAN-02 is the only activated task and remains unclaimed and not implemented.
