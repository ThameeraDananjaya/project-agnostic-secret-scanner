...
| PSCAN-09 | Proposed; unselected | Owner direction dated 2026-09-01; contract decommission and outcome-based replacement only |
...
It is rejected, closed fail-closed and unaccepted. No task is activated.

The owner abandoned the contract-preserving option on 2026-09-01 and directed
future work toward decommissioning PASS-SPEC-001 authority and establishing an
outcome-based replacement contract. PASS-SPEC-001 remains controlling until a
separately activated governance task completes that change; its historical
source and evidence must be preserved. PSCAN-09 is the single proposed,
unselected task for that work. PSCAN-04 through PSCAN-07 remain proposed and
unselected. PSCAN-08 remains inactive, unselected, and ineligible. No successor
