...
func TestReleaseVerificationRejectsEveryRequiredMutationBeforeScan(t *testing.T) {
	...
	manifestCases := map[string]func(*verify.ReleaseManifest){
		...
		"manifest release identity workflow": func(m *verify.ReleaseManifest) { m.ReleaseIdentity.Workflow = ".github/workflows/release-recovery-v1.0.0.yml" },
		"manifest release identity ref": func(m *verify.ReleaseManifest) { m.ReleaseIdentity.Ref = "refs/tags/release-tooling-v1.0.0-c2" },
		"manifest certificate identity": func(m *verify.ReleaseManifest) { m.ReleaseIdentity.CertificateIdentity = "https://github.com/ThameeraDananjaya/project-agnostic-secret-scanner/.github/workflows/release-recovery-v1.0.0.yml@refs/tags/release-tooling-v1.0.0-c2" },
...
func writeRelease(t *testing.T) (string, verify.ReleaseVerificationRequest) {
	...
	manifest := verify.ReleaseManifest{
		SchemaFamily: "scanner-release-manifest", ManifestSchemaVersion: "2.2", ReleaseVersion: "v1.0.0", RunnerVersion: "1.0.0", GoToolchainVersion: "go1.27.1",
		...
		ReleaseTooling: &verify.ReleaseToolingIdentity{Tag: "release-tooling-v1.0.0-c2-r6", Commit: "3fb1b0a55dc4f48dd35464c63c768f497efbc89b", Tree: "544867396910969d20cfd2acd454ac0d69c1d7e4", Workflow: ".github/workflows/release-recovery-v1.0.0-c2-r6.yml", WorkflowRef: "refs/tags/release-tooling-v1.0.0-c2-r6", WorkflowSHA: "3fb1b0a55dc4f48dd35464c63c768f497efbc89b", Trigger: "workflow_dispatch"},
		...
		ReleaseIdentity: verify.ReleaseIdentity{Repository: "ThameeraDananjaya/project-agnostic-secret-scanner", RepositoryOwnerID: 50274860, Workflow: ".github/workflows/release-recovery-v1.0.0-c2-r6.yml", Ref: "refs/tags/release-tooling-v1.0.0-c2-r6", WorkflowSHA: "3fb1b0a55dc4f48dd35464c63c768f497efbc89b", Trigger: "workflow_dispatch", OIDCIssuer: "https://token.actions.githubusercontent.com", CertificateIdentity: "https://github.com/ThameeraDananjaya/project-agnostic-secret-scanner/.github/workflows/release-recovery-v1.0.0-c2-r6.yml@refs/tags/release-tooling-v1.0.0-c2-r6"},
	...
	request := verify.ReleaseVerificationRequest{Directory: root, ManifestPath: "release-manifest.json", BundlePath: "release-manifest.sigstore.json", Policy: verify.ReleaseTrustPolicy{Repository: "ThameeraDananjaya/project-agnostic-secret-scanner", RepositoryOwnerID: 50274860, Workflow: ".github/workflows/release-recovery-v1.0.0-c2-r6.yml", Ref: "refs/tags/release-tooling-v1.0.0-c2-r6", WorkflowSHA: "3fb1b0a55dc4f48dd35464c63c768f497efbc89b", Trigger: "workflow_dispatch", OIDCIssuer: "https://token.actions.githubusercontent.com", CertificateIdentity: "https://github.com/ThameeraDananjaya/project-agnostic-secret-scanner/.github/workflows/release-recovery-v1.0.0-c2-r6.yml@refs/tags/release-tooling-v1.0.0-c2-r6", ReleaseVersion: "v1.0.0", ManifestSchemaVersion: "2.2", ProductSourceTag: "v1.0.0", ProductSourceCommit: "a13c28fe7273bc8dc6545f97966a02889524eb4c", ProductSourceTree: "217b711ddea51fd0ea7e808edd2e27fdecef8427", ReleaseToolingTag: "release-tooling-v1.0.0-c2-r6", ReleaseToolingCommit: "3fb1b0a55dc4f48dd35464c63c768f497efbc89b", ReleaseToolingTree: "544867396910969d20cfd2acd454ac0d69c1d7e4"}, Signature: exactSyntheticBundle{manifestDigest: verify.DigestBytes(raw), bundle: bundle}, Now: time.Date(2026, 9, 3, 1, 0, 0, 0, time.UTC)}
	return root, request
}
