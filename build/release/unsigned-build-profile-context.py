...
context.SOURCES = (
    ...
    'docker-execution.ps1', 'invoke-docker-boundary.ps1', 'native-fixture-diagnostics.ps1',
    'test-docker-execution.ps1', 'test-image-admission.ps1', 'image-admission.ps1',
    'test-cache-boundary.ps1', 'cache-canary.ps1', 'host-cache-canary.ps1',
    'admit-image.ps1', 'acquire.ps1', 'build.ps1', 'invoke-exact-build.ps1',
