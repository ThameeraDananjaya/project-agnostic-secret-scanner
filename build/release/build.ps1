...
PSCAN_GITLEAKS_BINARY=/out/gitleaks-linux-amd64 PSCAN_GITLEAKS_CONFIG=/src/rules/generic/gitleaks-v8.30.1.toml PSCAN_GITLEAKS_IGNORE=/src/rules/generic/gitleaks-ignore-empty-v1.txt /work/runner/go/bin/go test -count=1 ./...
/work/runner/go/bin/go vet ./...
GOOS=windows GOARCH=amd64 /work/runner/go/bin/go test -exec /bin/true ./...
